...
@media(max-width:340px){#connectedShell.worker-mobile-final .wm-next-card,#connectedShell.worker-mobile-final .wm-trust-card{grid-template-columns:40px minmax(0,1fr) auto!important;gap:8px!important}#connectedShell.worker-mobile-final .wm-next-card>button,#connectedShell.worker-mobile-final .wm-trust-card>button{min-height:36px!important;padding:0 7px!important;font-size:9.5px!important}#connectedShell.worker-mobile-final .wm-quick-grid{gap:6px!important}#connectedShell.worker-mobile-final .wm-quick-grid>button{padding:9px 6px!important}#connectedShell.worker-mobile-final .wm-quick-grid b{font-size:10.5px!important}#connectedShell.worker-mobile-final .wm-quick-grid small{font-size:9px!important}}`;
