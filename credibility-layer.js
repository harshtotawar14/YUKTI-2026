(() => {
  ...
  function credibilityHtml(){
    return `<div class="judge-card cred-hero"><span class="judge-badge">TOP-1 CREDIBILITY CENTER</span><h2>Why should a selector believe this system?</h2><p>SanPaid separates backend-derived proof, explanatory scenarios, sandbox flows, planned validation and future integrations instead of blending them together.</p><div class="cred-legend"><span class="live">Implemented / backend-derived</span><span class="connected">Connected workflow</span><span class="sandbox">Sandbox / simulation</span><span class="future">Future integration</span><span class="risk">Excluded / needs validation</span></div></div>
