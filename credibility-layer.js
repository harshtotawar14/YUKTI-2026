(() => {
  ...
  function validationCard(){
    return `<div class="cred-validation">
      <div><span class="cred-status planned">DEVICE CHECK REQUIRED</span><b>Real-world problem validation</b><p>No interview counts, testimonials or pilot results are claimed because verified field evidence has not been entered into the project.</p></div>
  ...
  function credibilityHtml(){
    return `<div class="judge-card cred-hero"><span class="judge-badge">SYSTEM CREDIBILITY</span><h2>How the platform separates evidence, implementation and future integrations</h2><p>SanPaid separates backend-derived proof, explanatory scenarios, sandbox flows, planned validation and future integrations instead of blending them together.</p><div class="cred-legend"><span class="live">Implemented / backend-derived</span><span class="connected">Connected workflow</span><span class="sandbox">Sandbox / simulation</span><span class="future">Future integration</span><span class="risk">Excluded / needs validation</span></div></div>
    <div class="judge-grid two" style="margin-top:12px">
      ...
      <div class="judge-card"><span class="judge-badge">LIVE SYSTEM EVIDENCE</span><h3>Public, sanitized and read-only</h3><p>Matching, fallback, command-center metrics and capacity proof can be checked without exposing admin mutation actions.</p><button class="btn primary small" type="button" data-cred-judge-proof>Load Connected Evidence</button><div id="credJudgeProof" aria-live="polite"></div></div>
    </div>
    ...
    <div class="judge-card" style="margin-top:12px"><span class="judge-badge">DEVICE VALIDATION MATRIX</span><h3>Cross-device validation status</h3><p>Required widths: 360 · 375 · 390 · 412 · 430 · 768 · 1024 · 1440. Browsers: Chrome desktop/Android, Edge desktop and Safari/iPhone if available.</p><span class="cred-status planned">NEEDS TEAM VALIDATION</span><div class="judge-note">Record real-device/browser checks before release; automated Chromium coverage remains separate from device-specific validation.</div></div>`;
  }
