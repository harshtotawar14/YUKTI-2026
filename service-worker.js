const CACHE_NAME = 'sanpaid-shell-v51';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css',
  ...
  './federation-govtech.css',
  './federation-portal.css',
  './cooperative-portal.css',
  './demo-first-stable.css',
  './customer-worker-dashboard.css',
  './app.js',
  ...
  './demo-first-stable.js',
  './customer-worker-dashboard.js',
